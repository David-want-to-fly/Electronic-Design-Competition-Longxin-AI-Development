...
# python val.py --data data/posture_data.yaml --weights runs/train/exp8/weights/best.pt --img 640
# python val.py --data data/safe_data.yaml --weights runs/train/exp5/weights/best.pt --img 640
