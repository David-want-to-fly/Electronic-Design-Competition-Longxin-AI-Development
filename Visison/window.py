...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.webcam = True
        # 放置权重文件
        self.model = self.model_load("D:/DL-ML-DRL/CV/yolo-series/yolov5-yolo412/Electronic_Design_Competition/Visison/runs/train/exp/weights/best.pt",
        ...
        if source == "":
            ...
            for path, im, im0s, vid_cap, s in dataset:
                ...
                for i, det in enumerate(pred):  # per image
                    ...
                    # 已经融合人脸识别，如果是为了调试，则注释掉下面一行
                    # recognize_result = Recognize(compre_face_base_url, api_key, "images/tmp/upload_show_result.jpg", 0,"0.8", 1, "landmarks", False)
